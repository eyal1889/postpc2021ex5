...
public class MainActivityTest extends TestCase {
  ...
  public void when_holderSays1ItemOfTypeInProgress_then_activityShouldShow1MatchingViewInRecyclerView(){
    ...
    //was a todo:
    CheckBox status = viewInRecycler.findViewById(R.id.status);
    TextView desc = viewInRecycler.findViewById(R.id.description);
    assertEquals(desc.getText(),"do homework");
  ...
  public void when_holderSays1ItemOfTypeDone_then_activityShouldShow1MatchingViewInRecyclerView(){
    ...
    CheckBox status = viewInRecycler.findViewById(R.id.status);
    TextView desc = viewInRecycler.findViewById(R.id.description);
    assertEquals(desc.getText(),"buy tomatoes");
